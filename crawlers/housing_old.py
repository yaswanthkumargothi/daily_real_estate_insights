...
async def after_goto(page: Page, context: BrowserContext, url: str, response, **kwargs):
    ...
    try:
        ...
        try:
            await page.click('text="Date Added"', timeout=10000)  # Increased timeout
            
            # Add significant wait time after completing all actions
            print("All actions completed, waiting to ensure data loads...")
            await asyncio.sleep(10)  # Wait 10 seconds after all actions complete
        except Exception as e:
...
# Additional housing.com related functions could be added here
